    ...
    <div class=" pt-4">
        ...
        <div class="text-end pb-4">
            <button type="button" class="btn btn-paragon-primary-lite " data-bs-toggle="modal" data-bs-target="#exampleModal">
                <i class="fa-solid fa-cube"></i> &nbsp;Crear nuevo permiso
            </button>
        </div>
            ...
            <div class="modal-dialog">
                <form action="{{route ('admin.permissions.store')}}" method="post">
                    ...
                    <div class="modal-content">
                        ...
                        <label class="col-form-label" for="name">Nombre del permiso:</label>
        ...
        <table id="tabla_usuario" class="table table" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route ('admin.permissions.show', $permission -> id )}}" class="btn btn-acciones">
                            <i class="fa-solid fa-eye"></i>
                        </a>
                        <a href="{{route ('admin.permissions.edit', $permission -> id )}}" class="btn btn-acciones">
